...
rag_root = script_dir.parent  # rag/
model_dir = rag_root / "llama" / "app" / "model"
...
def download_from_s3(
    ...
    Args:
        ...
        s3_prefix: S3 경로 prefix (예: "models/llama/")
...
def main():
    ...
    s3_prefix = os.getenv('S3_MODEL_PREFIX', 'models/llama/')
